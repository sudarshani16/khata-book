        ...
        <div class="panel-body">
            <form action="saveproject.php" method="POST" role="form">
                ...
                <div class="form-group">
                    ...
                    <input type="date" class="form-control" id="" name="txtdate" placeholder="Input field">
                </div>

                <div class="form-group">
                    <label for="">City</label>
                    <input type="text" class="form-control" id="" name="txtcity" placeholder="Input field">
                </div>
                <div class="form-group">
                    <label for="">Paid Amt</label>
                    <input type="text" class="form-control" id="" name="txtamt" placeholder="Input field">
                </div>
